  ...
  <div>
    ...
    <el-dialog title="添加讲师" :visible.sync="visibleAddForm">
      ...
      >
        <el-form-item label="编号" prop="teacherNo">
          <el-input
            v-model="addTeacherForm.teacherNo"
            autocomplete="off"
            disabled
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="姓名" prop="realname">
          <el-input
            v-model="addTeacherForm.realname"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="职称" prop="jobtitle">
          <el-input
            v-model="addTeacherForm.jobtitle"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="科目" prop="teach">
          <el-input
            v-model="addTeacherForm.teach"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="手机" prop="telephone">
          <el-input
            v-model="addTeacherForm.telephone"
            autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="邮件" prop="email">
